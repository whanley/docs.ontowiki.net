...
* if not already installed, install PHP with ODBC support `brew tap homebrew/homebrew-php`, then `brew install php56 --with-unixodbc`
* execute `brew install virtuoso` to install Virtuoso
